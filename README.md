...
考试分享第一版已经可用：用户可以从资源详情中的已完成试卷生成带有效期的公开考试链接，在“考试管理”查看参与统计和逐份答卷；管理员可以在“系统管理 / 考试管理”查看全平台考试。参与者支持平台账号、微信认证和匿名名称三种身份，重新打开链接时可按对应身份找回历史答卷。公开接口在交卷前隐藏答案与解析，并始终隐藏 PDF 文件名、页码和原文摘录；问答题异步评分失败后可由分享者或管理员重新评分。
