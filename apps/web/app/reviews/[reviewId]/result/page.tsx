...
export default function ReviewResultPage() {
  ...
  return (
    <div className="page-wrap">
      ...
      <div className="section-title"><h2>逐题复盘</h2><span>{result.source_mode === "model_knowledge" ? "模型知识说明已全部展开" : result.source_mode === "combined" ? "综合剧情、台词和可用原文依据已展开" : result.source_mode === "material" ? "可信台词依据已全部展开" : result.source_mode === "plot" ? "剧情梗概依据已全部展开" : "原文依据已全部展开"}</span></div>
