...
export default function ReviewsPage() {
  ...
  return (
    <div className="page-wrap">
      ...
      {reviews.length === 0 ? <EmptyState title="还没有复习记录" detail="从书籍详情页选择一套复习试卷，完成第一次复习后记录会出现在这里。" /> : <div className="history-table-wrap"><table className="history-table"><thead><tr><th>书籍与试卷</th><th>状态</th><th>次数</th><th>得分率</th><th>题量</th><th>用时</th><th>时间</th><th aria-label="操作" /></tr></thead><tbody>{reviews.map((review) => {
