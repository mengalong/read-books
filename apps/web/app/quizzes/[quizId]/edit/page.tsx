    ...
    <div className="page-wrap">
      ...
      <div className="quiz-choice-layout">
        ...
        <aside className="quiz-settings-summary">
          ...
          <dl><div><dt>难度</dt><dd>{quiz.difficulty === "easy" ? "基础" : quiz.difficulty === "hard" ? "深入" : "适中"}</dd></div><div><dt>来源</dt><dd>{quiz.source_mode === "model_knowledge" ? "模型知识" : quiz.source_mode === "material" ? "可信台词" : quiz.source_mode === "combined" ? "PDF + 可信台词" : "PDF 原文"}</dd></div><div><dt>状态</dt><dd>{quiz.status === "ready" ? "可复习" : "已提交"}</dd></div></dl>
        </aside>
      </div>
